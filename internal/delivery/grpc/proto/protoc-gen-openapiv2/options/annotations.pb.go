...
var (
	// ID assigned by pb-global-extension-registry@google.com for gRPC-Gateway project.
	//
...
var file_protoc_gen_openapiv2_options_annotations_proto_goTypes = []interface{}{
	(*descriptorpb.FileOptions)(nil),    // 0: google.pb.FileOptions
	(*descriptorpb.MethodOptions)(nil),  // 1: google.pb.MethodOptions
	(*descriptorpb.MessageOptions)(nil), // 2: google.pb.MessageOptions
	(*descriptorpb.ServiceOptions)(nil), // 3: google.pb.ServiceOptions
	(*descriptorpb.FieldOptions)(nil),   // 4: google.pb.FieldOptions
...
var file_protoc_gen_openapiv2_options_annotations_proto_depIdxs = []int32{
	0,  // 0: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_swagger:extendee -> google.pb.FileOptions
	1,  // 1: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_operation:extendee -> google.pb.MethodOptions
	2,  // 2: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_schema:extendee -> google.pb.MessageOptions
	3,  // 3: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_tag:extendee -> google.pb.ServiceOptions
	4,  // 4: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field:extendee -> google.pb.FieldOptions
