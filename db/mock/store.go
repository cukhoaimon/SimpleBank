...
// Source: github.com/cukhoaimon/SimpleBank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTxAccount(arg0 context.Context, arg1 db.TransferTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
